app.controller('teacher_option', ['$scope', '$filter', '$http', function ($scope, $filter, $http, $timeout) {
    $scope.classTeacher = [];
    $scope.teacher_id = "";
    $scope.teacher_name = "";
    $scope.class_id = "";
    ...
    $scope.selectSession = function () {
        $scope.show_jlse = !$scope.show_jlse;
        var session_weekly = {
    ...
    $scope.disklpline_teacher = function () {
        $scope.show_enz_teacher = !$scope.show_enz_teacher;
        var msg = {
            ...
            mutualTransaction: {
                kendoDataRequest: {
                    filter:
                        {field: "teacherid", logic: "and", operator: "eq", value: $scope.teacher_id},
                },
            }
        }
